  ...
  <div class="container">
    <article>
      ...
      <div class="box">
        <CENTER>
		<h1>
			${bean.memberNicknName}客官 <BR> <FONT COLOR='RED'></FONT><BR>
			感謝您購買優惠GO<BR> 期待客官再度遠臨
			<li><a href="<c:url value="/pages/_C_listCoupon/DisplayPageCoupons" />"><i class="fa fa-shopping-bag" aria-hidden="true"></i>重返市場</a></li><BR>
		</h1>
