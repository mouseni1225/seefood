...
<form class="well form-horizontal" action="<c:url value='/pages/information' />" method="post"  id="contact_form" enctype="multipart/form-data">
<fieldset>
...
<div class="form-group">
  ...
  <span class="input-group-addon"><i class="glyphicon glyphicon-user"></i></span>
    <input name="pic" placeholder="Last Name" class="form-control"  type="file">
    </div>
  </div>
</div>
...
<div class="form-group">
  <label class="col-md-4 control-label" >暱稱</label> 
    ...
    <div class="input-group">
  <span class="input-group-addon"><i class="glyphicon glyphicon-user"></i></span>
  <input name="memberNicknName" placeholder="Your Name" class="form-control"  type="text" value="${requestScope.memberNicknName }">
    </div>
  </div>
</div>
...
<!--         	<textarea class="form-control" name="memberBonus" placeholder="Project Description" ></textarea> -->
        	...
        	minlength="8" value="${requestScope.memberPassword2}"><label id="pwd22" style="color: red;">${ErrMsg.memberPassword2}</label>
