...
<meta http-equiv="Refresh" content="7;URL=<c:url value="/pages/login/login.jsp" />">
...
${memberNicknName},您好請到
${memberAddress}信箱收信。
<br>7秒後跳回登入畫面
</center>
      </div>
<c:remove var="memberAddress" scope="session"/>
<c:remove var="memberNicknName" scope="session"/>
    </article>
  </div>
</section>
