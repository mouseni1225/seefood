...
@WebServlet("/pages/information/getimg")
public class GuestGetImage extends HttpServlet{
	
	@Override
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		System.out.println("================來自GuestGetImage.java的訊息================");
		...
		try {
			...
			pstmt = conn.prepareStatement(" select memberBigPhoto from member where memberAddress=?");
